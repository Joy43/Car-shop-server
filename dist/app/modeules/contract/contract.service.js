...
const emailSendContract_1 = __importDefault(require("./emailSendContract"));
const contract_model_1 = __importDefault(require("./contract.model"));
const CreateContract = (data) => __awaiter(void 0, void 0, void 0, function* () {
    // Save contract data to the database
    const newContract = yield contract_model_1.default.create(data);
    // email HTML content
    const emailHTML = `
